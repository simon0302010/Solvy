                    ...
                    parameters=genai.types.Schema(
                        ...
                        properties={
                            "text": genai.types.Schema(
                                type=genai.types.Type.STRING,
                                description="The answer text to inserted. Latex equations HAVE to be embedded by typing $latex$. This function is the only option to add text or mathematical expressions to the worksheet. It is a necessary step in the solving of each task that requires an answer.",
                            ),
